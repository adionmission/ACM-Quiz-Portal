...
if(isset($_POST["foroption"]))
{
    $uuser4=$_POST["uuser4"];
	$option4=$_POST["foroption"];
}

$sql="INSERT INTO `acm4`(`username`,`option4`, `post_time`) VALUES ('$uuser4','$option4',CURRENT_TIMESTAMP)";
...
function countdown( elementName, minutes, seconds )
{
    ...
    function updateTimer()
    {
        ...
        if ( msLeft < 1000 ) {
            document.getElementById('body').innerHTML = "time over <a href='acm6.php' style='color:blue;'>continue to next question</a>";
...
<form method="post" action="acm6.php">
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="enter your username" name="uuser5">
				</div>
			</div>
		</div>
	</div>
...
$q5=$mq17=$mq18=$mq19=$mq20="";

while($r3=mysqli_fetch_array($result))
{
	$_SESSION["q5_session"] = $r3["q5"];
		$q5 = str_replace("\n","<br>",$_SESSION["q5_session"]);
	$_SESSION["mq17_session"] = $r3["mq17"];
		$mq17 = str_replace("\n","<br>",$_SESSION["mq17_session"]);
	$_SESSION["mq18_session"] = $r3["mq18"];	
		$mq18 = str_replace("\n","<br>",$_SESSION["mq18_session"]);
	$_SESSION["mq19_session"] = $r3["mq19"];	
		$mq19 = str_replace("\n","<br>",$_SESSION["mq19_session"]);
	$_SESSION["mq20_session"] = $r3["mq20"];	
		$mq20 = str_replace("\n","<br>",$_SESSION["mq20_session"]);
}
...
<div class="container" style="margin-top:40px;">
	...
	<h6>Question 5 of 10 \ Multiple Choice Questions</h6>
	<br>
	<h1><kbd>5.</kbd> <?php echo $q5; ?></h1> 
	<br>
	<hr>
	<br>
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="fiveoption" value="<?php echo $mq17; ?>"><?php echo $mq17; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="fiveoption" value="<?php echo $mq18; ?>"><?php echo $mq18; ?></label>
			</div>
		</div>
		</h3>
		</center>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="fiveoption" value="<?php echo $mq19; ?>"><?php echo $mq19; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="fiveoption" value="<?php echo $mq20; ?>"><?php echo $mq20; ?></label>
			</div>
		</div>
		</h3>
		</center>
					...
					<div class="modal-dialog">
						<div class="modal-content w3-animate-zoom">
							...
							<div class="modal-footer">
								<button type="submit" name="yes5" class="btn btn-primary">yes <span class="glyphicon glyphicon-thumbs-up"></span></button>
