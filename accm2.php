...
{
	$_SESSION["q1_session"] = $r1["q1"];
		$q1 = str_replace("\n","<br>",$_SESSION["q1_session"]);
	$_SESSION["mq1_session"] = $r1["mq1"];
		$mq1 = str_replace("\n","<br>",$_SESSION["mq1_session"]);
	$_SESSION["mq2_session"] = $r1["mq2"];	
		$mq2 = str_replace("\n","<br>",$_SESSION["mq2_session"]);
	$_SESSION["mq3_session"] = $r1["mq3"];	
		$mq3 = str_replace("\n","<br>",$_SESSION["mq3_session"]);
	$_SESSION["mq4_session"] = $r1["mq4"];	
		$mq4 = str_replace("\n","<br>",$_SESSION["mq4_session"]);
}
...
function countdown( elementName, minutes, seconds )
{
    ...
    function updateTimer()
    {
        ...
        if ( msLeft < 1000 ) {
			document.getElementById('body').innerHTML = "time over <a href='acm2.php' style='color:blue;'>continue to next question</a>";
...
<form method="post" action="acm2.php">
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="enter your username" name="uuser1">
				</div>
			</div>
		</div>
	</div>
...
<div class="container" style="margin-top:50px;">
	...
	<h6>Question 1 of 10 \ Multiple Choice Questions</h6>
	<br>
	<h1><kbd>1.</kbd> <?php echo $q1; ?></h1> 
	<br>
	<hr>
	<br>
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="fstoption" value="<?php echo $mq1; ?>"><?php echo $mq1; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="fstoption" value="<?php echo $mq2; ?>"><?php echo $mq2; ?></label>
			</div>
		</div>
		</h3>
		</center>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="fstoption" value="<?php echo $mq3; ?>"><?php echo $mq3; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="fstoption" value="<?php echo $mq4; ?>"><?php echo $mq4; ?></label>
			</div>
		</div>
		</h3>
		</center>
					...
					<div class="modal-dialog">
						<div class="modal-content w3-animate-zoom">
							...
							<div class="modal-footer">
								<button type="submit" name="yes1" class="btn btn-primary">yes <span class="glyphicon glyphicon-thumbs-up"></span></button>
