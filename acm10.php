...
if(isset($_POST["nineoption"]))
{
    $uuser9=$_POST["uuser9"];
	$option9=$_POST["nineoption"];
}

$sql="INSERT INTO `acm9`(`username`,`option9`, `post_time`) VALUES ('$uuser9','$option9',CURRENT_TIMESTAMP)";

mysqli_query($conn,$sql) or die(mysqli_error($conn));

if(mysqli_affected_rows($conn)>0)
{
	$_SESSION["user10"] = true;
}
...
function countdown( elementName, minutes, seconds )
{
    ...
    function updateTimer()
    {
        ...
        if ( msLeft < 1000 ) {
			document.getElementById('body').innerHTML = "time over <a href='acm11.php' style='color:blue;'>continue to next question</a>";
...
<form method="post" action="acm11.php">
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="enter your username" name="uuser10">
				</div>
			</div>
		</div>
	</div>
...
$q9=$mq37=$mq38=$mq39=$mq40="";

while($r3=mysqli_fetch_array($result))
{
	$_SESSION["q10_session"] = $r3["q10"];
		$q10 = str_replace("\n","<br>",$_SESSION["q10_session"]);
	$_SESSION["mq37_session"] = $r3["mq37"];
		$mq37 = str_replace("\n","<br>",$_SESSION["mq37_session"]);
	$_SESSION["mq38_session"] = $r3["mq38"];	
		$mq38 = str_replace("\n","<br>",$_SESSION["mq38_session"]);
	$_SESSION["mq39_session"] = $r3["mq39"];	
		$mq39 = str_replace("\n","<br>",$_SESSION["mq39_session"]);
	$_SESSION["mq40_session"] = $r3["mq40"];	
		$mq40 = str_replace("\n","<br>",$_SESSION["mq40_session"]);
}
...
<div class="container" style="margin-top:40px;">
	...
	<h6>Question 10 of 10 \ Multiple Choice Questions</h6>
	<br>
	<h1><kbd>10.</kbd> <?php echo $q10; ?></h1> 
	<br>
	<hr>
	<br>
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="tenoption" value="<?php echo $mq37; ?>"><?php echo $mq37; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="tenoption" value="<?php echo $mq38; ?>"><?php echo $mq38; ?></label>
			</div>
		</div>
		</h3>
		</center>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="tenoption" value="<?php echo $mq39; ?>"><?php echo $mq39; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="tenoption" value="<?php echo $mq40; ?>"><?php echo $mq40; ?></label>
			</div>
		</div>
		</h3>
		</center>
	...
	<div class="row">
		<div class="col-sm-12">
			<button type="button" class="btn btn-primary w3-right" data-toggle="modal" data-target="#mymodal2">save and submit <span class="fa fa-arrow-right"></span></button>
					...
					<div class="modal-dialog">
						<div class="modal-content w3-animate-zoom">
							...
							<div class="modal-footer">
								<button type="submit" name="yes10" class="btn btn-primary">yes <span class="glyphicon glyphicon-thumbs-up"></span></button>
