...
if(isset($_POST["sixoption"]))
{
    $uuser6=$_POST["uuser6"];
	$option6=$_POST["sixoption"];
}

$sql="INSERT INTO `acm6`(`username`,`option6`, `post_time`) VALUES ('$uuser6','$option6',CURRENT_TIMESTAMP)";
...
function countdown( elementName, minutes, seconds )
{
    ...
    function updateTimer()
    {
        ...
        if ( msLeft < 1000 ) {
			document.getElementById('body').innerHTML = "time over <a href='acm8.php' style='color:blue;'>continue to next question</a>";
...
<form method="post" action="acm8.php">
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="enter your username" name="uuser7">
				</div>
			</div>
		</div>
	</div>
...
$q7=$mq25=$mq26=$mq27=$mq28="";

while($r3=mysqli_fetch_array($result))
{
	$_SESSION["q7_session"] = $r3["q7"];
		$q7 = str_replace("\n","<br>",$_SESSION["q7_session"]);
	$_SESSION["mq25_session"] = $r3["mq25"];
		$mq25 = str_replace("\n","<br>",$_SESSION["mq25_session"]);
	$_SESSION["mq26_session"] = $r3["mq26"];	
		$mq26 = str_replace("\n","<br>",$_SESSION["mq26_session"]);
	$_SESSION["mq27_session"] = $r3["mq27"];	
		$mq27 = str_replace("\n","<br>",$_SESSION["mq27_session"]);
	$_SESSION["mq28_session"] = $r3["mq28"];	
		$mq28 = str_replace("\n","<br>",$_SESSION["mq28_session"]);
}
...
<div class="container" style="margin-top:40px;">
	...
	<h6>Question 7 of 10 \ Multiple Choice Questions</h6>
	<br>
	<h1><kbd>7.</kbd> <?php echo $q7; ?></h1> 
	<br>
	<hr>
	<br>
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="sevoption" value="<?php echo $mq25; ?>"><?php echo $mq25; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="sevoption" value="<?php echo $mq26; ?>"><?php echo $mq26; ?></label>
			</div>
		</div>
		</h3>
		</center>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="sevoption" value="<?php echo $mq27; ?>"><?php echo $mq27; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="sevoption" value="<?php echo $mq28; ?>"><?php echo $mq28; ?></label>
			</div>
		</div>
		</h3>
		</center>
					...
					<div class="modal-dialog">
						<div class="modal-content w3-animate-zoom">
							...
							<div class="modal-footer">
								<button type="submit" name="yes7" class="btn btn-primary">yes <span class="glyphicon glyphicon-thumbs-up"></span></button>
