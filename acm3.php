...
if(isset($_POST["secoption"]))
{
    $uuser2=$_POST["uuser2"];
	$option2=$_POST["secoption"];
}

$sql="INSERT INTO `acm2`(`username`, `option2`, `post_time`) VALUES ('$uuser2','$option2',CURRENT_TIMESTAMP)";
...
function countdown( elementName, minutes, seconds )
{
    ...
    function updateTimer()
    {
        ...
        if ( msLeft < 1000 ) {
            document.getElementById('body').innerHTML = "time over <a href='acm4.php' style='color:blue;'>continue to next question</a>";
...
<form method="post" action="acm4.php">
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="enter your username" name="uuser3">
				</div>
			</div>
		</div>
	</div>
...
$q3=$mq9=$mq10=$mq11=$mq12="";

while($r2=mysqli_fetch_array($result))
{
	$_SESSION["q3_session"] = $r2["q3"];
		$q3 = str_replace("\n","<br>",$_SESSION["q3_session"]);
	$_SESSION["mq9_session"] = $r2["mq9"];
		$mq9 = str_replace("\n","<br>",$_SESSION["mq9_session"]);
	$_SESSION["mq10_session"] = $r2["mq10"];	
		$mq10 = str_replace("\n","<br>",$_SESSION["mq10_session"]);
	$_SESSION["mq11_session"] = $r2["mq11"];	
		$mq11 = str_replace("\n","<br>",$_SESSION["mq11_session"]);
	$_SESSION["mq12_session"] = $r2["mq12"];	
		$mq12 = str_replace("\n","<br>",$_SESSION["mq12_session"]);
}
...
<div class="container" style="margin-top:40px;">
	...
	<h6>Question 3 of 10 \ Multiple Choice Questions</h6>
	<br>
	<h1><kbd>3.</kbd> <?php echo $q3; ?></h1> 
	<br>
	<hr>
	<br>
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="thirdoption" value="<?php echo $mq9; ?>"><?php echo $mq9; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="thirdoption" value="<?php echo $mq10; ?>"><?php echo $mq10; ?></label>
		</div>
		</h3>
		</center>
	</div>
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="thirdoption" value="<?php echo $mq11; ?>"><?php echo $mq11; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="thirdoption" value="<?php echo $mq12; ?>"><?php echo $mq12; ?></label>
			</div>
		</div>
		</h3>
		</center>
					...
					<div class="modal-dialog">
						<div class="modal-content w3-animate-zoom">
							...
							<div class="modal-footer">
								<button type="submit" name="yes3" class="btn btn-primary">yes <span class="glyphicon glyphicon-thumbs-up"></span></button>
