...
if(isset($_POST["eigoption"]))
{
    $uuser8=$_POST["uuser8"];
	$option8=$_POST["eigoption"];
}

$sql="INSERT INTO `acm8`(`username`,`option8`, `post_time`) VALUES ('$uuser8','$option8',CURRENT_TIMESTAMP)";
...
function countdown( elementName, minutes, seconds )
{
    ...
    function updateTimer()
    {
        ...
        if ( msLeft < 1000 ) {
			document.getElementById('body').innerHTML = "time over <a href='acm10.php' style='color:blue;'>continue to next question</a>";
...
<form method="post" action="acm10.php">
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="enter your username" name="uuser9">
				</div>
			</div>
		</div>
	</div>
...
$q9=$mq33=$mq34=$mq35=$mq36="";

while($r3=mysqli_fetch_array($result))
{
	$_SESSION["q9_session"] = $r3["q9"];
		$q9 = str_replace("\n","<br>",$_SESSION["q9_session"]);
	$_SESSION["mq33_session"] = $r3["mq33"];
		$mq33 = str_replace("\n","<br>",$_SESSION["mq33_session"]);
	$_SESSION["mq34_session"] = $r3["mq34"];	
		$mq34 = str_replace("\n","<br>",$_SESSION["mq34_session"]);
	$_SESSION["mq35_session"] = $r3["mq35"];	
		$mq35 = str_replace("\n","<br>",$_SESSION["mq35_session"]);
	$_SESSION["mq36_session"] = $r3["mq36"];	
		$mq36 = str_replace("\n","<br>",$_SESSION["mq36_session"]);
}
...
<div class="container" style="margin-top:40px;">
	...
	<h6>Question 9 of 10 \ Multiple Choice Questions</h6>
	<br>
	<h1><kbd>9.</kbd> <?php echo $q9; ?></h1> 
	<br>
	<hr>
	<br>
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="nineoption" value="<?php echo $mq33; ?>"><?php echo $mq33; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="nineoption" value="<?php echo $mq34; ?>"><?php echo $mq34; ?></label>
			</div>
		</div>
		</h3>
		</center>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="nineoption" value="<?php echo $mq35; ?>"><?php echo $mq35; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="nineoption" value="<?php echo $mq36; ?>"><?php echo $mq36; ?></label>
			</div>
		</div>
		</h3>
		</center>
					...
					<div class="modal-dialog">
						<div class="modal-content w3-animate-zoom">
							...
							<div class="modal-footer">
								<button type="submit" name="yes9" class="btn btn-primary">yes <span class="glyphicon glyphicon-thumbs-up"></span></button>
