...
if(isset($_POST["thirdoption"]))
{
    $uuser3=$_POST["uuser3"];
	$option3=$_POST["thirdoption"];
}

$sql="INSERT INTO `acm3`(`username`,`option3`, `post_time`) VALUES ('$uuser3','$option3',CURRENT_TIMESTAMP)";
...
function countdown( elementName, minutes, seconds )
{
    ...
    function updateTimer()
    {
        ...
        if ( msLeft < 1000 ) {
			document.getElementById('body').innerHTML = "time over <a href='acm5.php' style='color:blue;'>continue to next question</a>";
...
<form method="post" action="acm5.php">
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="enter your username" name="uuser4">
				</div>
			</div>
		</div>
	</div>
...
$q4=$mq13=$mq14=$mq15=$mq16="";

while($r3=mysqli_fetch_array($result))
{
	$_SESSION["q4_session"] = $r3["q4"];
		$q4 = str_replace("\n","<br>",$_SESSION["q4_session"]);
	$_SESSION["mq13_session"] = $r3["mq13"];
		$mq13 = str_replace("\n","<br>",$_SESSION["mq13_session"]);
	$_SESSION["mq14_session"] = $r3["mq14"];	
		$mq14 = str_replace("\n","<br>",$_SESSION["mq14_session"]);
	$_SESSION["mq15_session"] = $r3["mq15"];	
		$mq15 = str_replace("\n","<br>",$_SESSION["mq15_session"]);
	$_SESSION["mq16_session"] = $r3["mq16"];	
		$mq16 = str_replace("\n","<br>",$_SESSION["mq16_session"]);
}
...
<div class="container" style="margin-top:40px;">
	...
	<h6>Question 4 of 10 \ Multiple Choice Questions</h6>
	<br>
	<h1><kbd>4.</kbd> <?php echo $q4; ?></h1> 
	<br>
	<hr>
	<br>
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="foroption" value="<?php echo $mq13; ?>"><?php echo $mq13; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="foroption" value="<?php echo $mq14; ?>"><?php echo $mq14; ?></label>
			</div>
		</div>
		</h3>
		</center>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="foroption" value="<?php echo $mq15; ?>"><?php echo $mq15; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="foroption" value="<?php echo $mq16; ?>"><?php echo $mq16; ?></label>
			</div>
		</div>
		</h3>
		</center>
					...
					<div class="modal-dialog">
						<div class="modal-content w3-animate-zoom">
							...
							<div class="modal-footer">
								<button type="submit" name="yes4" class="btn btn-primary">yes <span class="glyphicon glyphicon-thumbs-up"></span></button>
