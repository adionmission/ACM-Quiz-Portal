...
if(isset($_POST["fiveoption"]))
{
    $uuser5=$_POST["uuser5"];
	$option5=$_POST["fiveoption"];
}

$sql="INSERT INTO `acm5`(`username`,`option5`, `post_time`) VALUES ('$uuser5','$option5',CURRENT_TIMESTAMP)";
...
function countdown( elementName, minutes, seconds )
{
    ...
    function updateTimer()
    {
        ...
        if ( msLeft < 1000 ) {
			document.getElementById('body').innerHTML = "time over <a href='acm7.php' style='color:blue;'>continue to next question</a>";
...
<form method="post" action="acm7.php">
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" class="form-control" placeholder="enter your username" name="uuser6">
				</div>
			</div>
		</div>
	</div>
...
$q6=$mq21=$mq22=$mq23=$mq24="";

while($r3=mysqli_fetch_array($result))
{
	$_SESSION["q6_session"] = $r3["q6"];
		$q6 = str_replace("\n","<br>",$_SESSION["q6_session"]);
	$_SESSION["mq21_session"] = $r3["mq21"];
		$mq21 = str_replace("\n","<br>",$_SESSION["mq21_session"]);
	$_SESSION["mq22_session"] = $r3["mq22"];	
		$mq22 = str_replace("\n","<br>",$_SESSION["mq22_session"]);
	$_SESSION["mq23_session"] = $r3["mq23"];	
		$mq23 = str_replace("\n","<br>",$_SESSION["mq23_session"]);
	$_SESSION["mq24_session"] = $r3["mq24"];	
		$mq24 = str_replace("\n","<br>",$_SESSION["mq24_session"]);
}
...
<div class="container" style="margin-top:40px;">
	...
	<h6>Question 6 of 10 \ Multiple Choice Questions</h6>
	<br>
	<h1><kbd>6.</kbd> <?php echo $q6; ?></h1> 
	<br>
	<hr>
	<br>
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="sixoption" value="<?php echo $mq21; ?>"><?php echo $mq21; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="sixoption" value="<?php echo $mq22; ?>"><?php echo $mq22; ?></label>
			</div>
		</div>
		</h3>
		</center>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="sixoption" value="<?php echo $mq23; ?>"><?php echo $mq23; ?></label>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="radio">
				<label><input type="radio" name="sixoption" value="<?php echo $mq24; ?>"><?php echo $mq24; ?></label>
			</div>
		</div>
		</h3>
		</center>
					...
					<div class="modal-dialog">
						<div class="modal-content w3-animate-zoom">
							...
							<div class="modal-footer">
								<button type="submit" name="yes6" class="btn btn-primary">yes <span class="glyphicon glyphicon-thumbs-up"></span></button>
